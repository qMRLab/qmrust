...
```{figure} ../../figures/inversion_recovery/inputs.webp
:label: fig-inversion_recovery-inputs
The 9 acquired volumes, each labeled with the identity the model reads it by.
```

```{figure} ../../figures/inversion_recovery/aux.webp
:label: fig-inversion_recovery-aux
...
```{figure} ../../figures/inversion_recovery/outputs.webp
:label: fig-inversion_recovery-outputs
...
sim:
  ...
  distributions:
    T1: { mean: 0.9, std: 0.15 }
```

```bash
qmrust sim signal       --config recipes/sim/irt1_sim.yaml --output signal.json
...
qmrust sim montecarlo   --config recipes/sim/irt1_sim.yaml --output mc.json
```
...
```{figure} ../../figures/inversion_recovery/curve.webp
:label: fig-inversion_recovery-curve
